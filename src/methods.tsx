...
export const addGame = (name: string) => {
  return axios.post(`${URL}/games`, { name });
};

export const deleteGame = (game_id: string) => {
  return axios.delete(`${URL}/games?game_id=${game_id}`);
};

export const renameGame = (name: string, game_id: string) => {
  return axios.patch(`${URL}/games?game_id=${game_id}`, { name });
};
...
export const getLocation = (game_id: string, loc_id: string) => {
  return axios.get(
    `${URL}/games/locations?game_id=${game_id}&loc_id=${loc_id}`,
  );
};
...
export const getLocationItems = (game_id: string, location_id: string) => {
  return axios.get(
    `${URL}/games/locations/items?game_id=${game_id}&loc_id=${location_id}`,
  );
};

export const addNewItem = (
  item: { name: string; type: string; [key: string]: unknown },
  game_id: string,
  location_id = null,
) => {
  if (!location_id) {
    ...
    return axios.post(
      `${URL}/games/items?game_id=${game_id}&loc_id=${location_id}`,
      item,
    );
  }
};
...
export const deleteItem = (game_id: string, item_id: string) => {
  return axios.delete(
    `${URL}/games/items?game_id=${game_id}&item_id=${item_id}`,
  );
};
...
export const moveItem = (
  ...
  return axios.patch(
    `${URL}/games/items/locations?game_id=${game_id}&loc_id=${loc_id}&item_id=${item_id}`,
    { loc_id: new_loc },
  );
};

export const changeItemFields = (
